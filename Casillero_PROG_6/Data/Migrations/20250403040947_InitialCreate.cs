        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tracking = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    Flete = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Paquetes_Categorias_Categoria",
                        column: x => x.Categoria,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Paquetes_Tarifas_servicio",
                        column: x => x.servicio,
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "Clave", "Email", "Nombre", "NombreUsuario", "Telefono", "Tipo" },
                values: new object[] { 1, "admin123", "admin@casillero.com", "Administrador", "admin", "1234-5678", 2 });

            migrationBuilder.CreateIndex(
                name: "IX_Paquetes_Categoria",
                table: "Paquetes",
                column: "Categoria");

            migrationBuilder.CreateIndex(
                name: "IX_Paquetes_servicio",
                table: "Paquetes",
                column: "servicio");
        }
